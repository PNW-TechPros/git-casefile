import GitInteraction, { ASSERT_ERROR, GitInterationError as ExtendedError, gitEmptyTree, strrpart } from '../lib/gitInteraction';
...
describe('GitInteraction', () => {
  ...
  describe('.prototype.getCasefileContentLines()', function () {
    ...
    it('can retrieve the content lines of a file', async function () {
      ...
      const result = await this.repo.getCasefileContentLines(casefilePath);
    ...
    it('rejects if git exits with an error', async function () {
      ...
      await expect(this.repo.getCasefileContentLines(casefilePath))
